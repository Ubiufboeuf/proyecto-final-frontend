...
export function SelectableBusTypeLight ({ busType: { icon, type, title, description, borderColor, bgColor: backgroundColor, mainColor: color, capacity, tags } }: { busType: BusType }) {
