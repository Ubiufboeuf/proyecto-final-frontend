...
export const IconMoon = ({ hidden = false }: { hidden?: boolean }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width='24'
    height='24'
...
export const IconSun = ({ hidden = false }: { hidden?: boolean }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width='24'
    height='24'
...
export const IconComputer = ({ hidden = false }: { hidden?: boolean }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width='24'
    height='24'
