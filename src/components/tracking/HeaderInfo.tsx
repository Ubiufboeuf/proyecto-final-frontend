...
export function HeaderInfo ({ buses }: { buses: Buses }) {
  ...
  return (
    <section class='flex items-center justify-center w-fit h-fit max-h-full p-3 gap-3'>
      <span class={`
        ${buses.count ? 'hasBuses' : ''} [&.hasBuses]:text-blue-700 [&.hasBuses]:bg-blue-100 [&.hasBuses]:border-blue-300 text-gray-700 bg-gray-100 border-gray-300
        ...
        <span class='xxs:hidden'>/{buses.count}</span>
      </span>
